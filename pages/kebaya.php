...
<head>
  ...
  .badge-pill { 
    ...
    border-radius: 999px; background: #dc143c; color: #fff; 
    font-size: 12px; text-align: center; position: absolute; top: -8px; right: -10px; 
...
<nav>
  ...
  <div class="icons">
    ...
    <a href="../wishlist.php" aria-label="Wishlist">
      ...
      <span id="wishlist-count" class="badge-pill <?php echo $wishlistCount ? '' : 'hidden'; ?>">
        <?php echo $wishlistCount; ?>
      </span>
    </a>
    <a href="../cart.php" aria-label="Cart">
      <i class="fas fa-shopping-cart"></i>
      <span id="cart-count" class="badge-pill <?php echo $cartCount ? '' : 'hidden'; ?>">
        <?php echo $cartCount; ?>
      </span>
    </a>
  </div>
...
<section class="trending-product" id="trending">
  <div class="center-text">
    <h2>Kebaya <span>Collection</span></h2>
  </div>
    ...
    <div class="row">
      <div class="image-holder">
        ...
        <div class="action-icons">
          <button class="btn-circle wishlist-toggle <?= $inWishlist ? 'active' : '' ?>" data-id="<?= $row['id'] ?>">
            <i class="<?= $inWishlist ? 'fas' : 'far' ?> fa-heart"></i>
          </button>
          <button class="btn-circle add-to-cart" data-id="<?= $row['id'] ?>">
            <i class="fas fa-shopping-cart"></i>
          </button>
          <button class="btn-circle buy-now" data-id="<?= $row['id'] ?>">
      ...
      <div class="rating" aria-hidden="true">
        ...
        <i class='bx bx-star'></i><i class='bx bxs-star-half'></i>
      </div>
      <div class="price">
...
$(document).on('click', '.wishlist-toggle', function() {
  ...
  $.post('../service/add-to-wishlist.php', { id: id, action: 'toggle' }, function(res) {
    ...
    if(data.success){
      ...
      if(data.added){ $icon.removeClass('far').addClass('fas'); }
