...
<body class="homepage">
    ...
    <div class="search-popup-container">
      ...
      <ul class="cat-list">
        <li class="cat-list-item">
          <a href="pages/kebaya.php" title="kebaya">Kebaya</a>
        </li>
        <li class="cat-list-item">
          <a href="pages/dresses.php" title="Dress">Dress</a>
        </li>
        <li class="cat-list-item">
          <a href="pages/heels.php" title="Heels">Heels</a>
        </li>
      </ul>
  ...
  <svg width="200" height="50" xmlns="http://www.w3.org/2000/svg">
    <text x="0" y="35" font-family="Playfair Display, serif" font-size="30" fill="#111">Gifaattire</text>
  </svg>
</a>
              ...
              <ul class="navbar-nav justify-content-end flex-grow-1 gap-1 gap-md-5 pe-3">
                ...
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu list-unstyled" aria-labelledby="dropdownShop">
                    <li>
                      <a href="pages/kebaya.php" class="dropdown-item item-anchor">Kebaya Collection </a>
                    </li>
                    <li>
                      <a href="pages/dresses.php" class="dropdown-item item-anchor">Dresses </a>
                    </li>
                    <li>
                      <a href="pages/heels.php" class="dropdown-item item-anchor">Heels & flatshoes</a>
                    </li>
                  </ul>
                </li>
                ...
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu list-unstyled" aria-labelledby="dropdownPages">
                    <li>
                      <a href="pages/rules.php" class="dropdown-item item-anchor">Rules </a>
                    </li>
                    <li>
                    ...
                    <li>
                      <a href="profile.php" class="dropdown-item item-anchor">My Account </a>
                    </li>
                    <li>
                    </li>
                    <li>
  ...
  <ul class="list-unstyled d-flex m-0">
    ...
    <li class="d-none d-lg-block">
      <a href="wishlist.php" class="mx-2" title="Wishlist">
    ...
    <li class="d-none d-lg-block">
      <a href="#" class="mx-2" title="Cart" data-bs-toggle="offcanvas" data-bs-target="#offcanvasCart" aria-controls="offcanvasCart">
        <svg width="24" height="24" viewBox="0 0 24 24">
  ...
  <li class="d-none d-lg-block">
    <?php if (isset($_SESSION['is_login']) && $_SESSION['is_login']): ?>
      ...
      <a href="profile.php" class="mx-2" title="Profile">
        <svg width="24" height="24" viewBox="0 0 24 24">
    ...
    <?php else: ?>
      ...
      <a href="login.php" class="mx-2" title="Login">
        <svg width="24" height="24" viewBox="0 0 24 24">
          <use xlink:href="#user"></use>
        </svg>
      </a>
    ...
    <li class="d-lg-none">
      <a href="wishlist.html" class="mx-2" title="Wishlist">
        <svg width="24" height="24" viewBox="0 0 24 24">
          <use xlink:href="#heart"></use>
        </svg>
      </a>
    ...
    <li class="d-lg-none">
      <a href="pages/login.php" class="mx-2" title="Login">
        <svg width="24" height="24" viewBox="0 0 24 24">
          <use xlink:href="#user"></use>
        </svg>
      </a>
  ...
  <section id="billboard" class="bg-light py-5">
    <div class="container">
      <div class="row justify-content-center">
        <h1 class="section-title text-center mt-4" data-aos="fade-up">Gifaattire</h1>
        <div class="col-md-6 text-center" data-aos="fade-up" data-aos-delay="300">
          <p>"Your One-Stop Rental for Kebaya, Dresses & Heels – Perfect Elegance for Every Occasion." <br>
We offer a wide selection of modern and traditional kebaya, elegant party dresses, and stylish heels to complete your look. Perfect for graduations, engagements, bridesmaids, and any other special event.</p>
        </div>
      </div>
      <div class="row">
          ...
          <div class="swiper-wrapper d-flex border-animation-left">
            <div class="swiper-slide">
              <div class="banner-item image-zoom-effect">
                <div class="image-holder">
                  <a href="#">
                    <img src="images/banner5.jpg" alt="product" class="img-fluid">
                  </a>
                </div>
            ...
            <div class="swiper-slide">
              <div class="banner-item image-zoom-effect">
                <div class="image-holder">
                  <a href="#">
                    <img src="images/banner3.jpg" alt="product" class="img-fluid">
                  </a>
                </div>
                <div class="banner-content py-4">
                  <h5 class="element-title text-uppercase">
            ...
            <div class="swiper-slide">
              <div class="banner-item image-zoom-effect">
                <div class="image-holder">
                  <a href="#">
                    <img src="images/d16.jpg" alt="product" class="img-fluid">
                  </a>
                </div>
                <div class="banner-content py-4">
                  <h5 class="element-title text-uppercase">
            ...
            <div class="swiper-slide">
              <div class="banner-item image-zoom-effect">
                <div class="image-holder">
                  <a href="#">
                    <img src="images/banner4.jpg" alt="product" class="img-fluid">
                  </a>
                </div>
                <div class="banner-content py-4">
                  <h5 class="element-title text-uppercase">
            ...
            <div class="swiper-slide">
              <div class="banner-item image-zoom-effect">
                <div class="image-holder">
                  <a href="#">
                    <img src="images/d17.jpg" alt="product" class="img-fluid">
                  </a>
                </div>
                <div class="banner-content py-4">
                  <h5 class="element-title text-uppercase">
            ...
            <div class="swiper-slide">
              <div class="banner-item image-zoom-effect">
                <div class="image-holder">
                  <a href="#">
                    <img src="images/banner-img5.jpg" alt="product" class="img-fluid">
                  </a>
                </div>
                <div class="banner-content py-4">
                  <h5 class="element-title text-uppercase">
      ...
      <div class="row">
        <div class="col-md-3 text-center" data-aos="fade-in" data-aos-delay="0">
          <div class="py-5">
            ...
            <h4 class="element-title text-capitalize my-3">Fast & Easy Booking</h4>
            <p>Enjoy a quick and hassle-free booking process through our website or costumer service team.</p>
          </div>
        </div>
        <div class="col-md-3 text-center" data-aos="fade-in" data-aos-delay="300">
          <div class="py-5">
            ...
            <h4 class="element-title text-capitalize my-3">In-Store Pickup Available</h4>
            <p>Pick up your order directly at our store and try it on to ensure the perfect fit.</p>
          </div>
        </div>
        <div class="col-md-3 text-center" data-aos="fade-in" data-aos-delay="600">
          <div class="py-5">
            ...
            <h4 class="element-title text-capitalize my-3">Exclusive Packaging</h4>
            <p>Each item is carefully packaged to ensure it arrives in perfect condition and ready to wear.</p>
          </div>
        </div>
        <div class="col-md-3 text-center" data-aos="fade-in" data-aos-delay="900">
          <div class="py-5">
            ...
            <h4 class="element-title text-capitalize my-3">Easy & flexible Returns </h4>
            <p>We provide a simple ajd convenient return process with clear terms and friendly service.</p>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="cat-item image-zoom-effect">
              <div class="image-holder">
                <a href="pages/kebaya.php">
                  <img src="images/rent.jpg" alt="categories" class="product-image img-fluid">
                </a>
              </div>
              <div class="category-content">
                <div class="product-button">
                  <a href="pages/kebaya.php" class="btn btn-common text-uppercase">rent kebaya</a>
                </div>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="cat-item image-zoom-effect">
              <div class="image-holder">
                <a href="pages/dresses.php">
                  <img src="images/item2.jpg" alt="categories" class="product-image img-fluid">
                </a>
              </div>
              <div class="category-content">
                <div class="product-button">
                  <a href="pages/dresses.php" class="btn btn-common text-uppercase">rent dress</a>
                </div>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="cat-item image-zoom-effect">
              <div class="image-holder">
                <a href="pages/heels.php">
                  <img src="images/item3.jpg" alt="categories" class="product-image img-fluid">
                </a>
              </div>
              <div class="category-content">
                <div class="product-button">
                  <a href="pages/heels.php" class="btn btn-common text-uppercase">rent heels</a>
                </div>
              </div>
            </div>
          </div>
 ...
 <section id="new-arrival" class="new-arrival product-carousel py-5 position-relative overflow-hidden">
  <div class="container">
    <div class="d-flex flex-wrap justify-content-between align-items-center mt-5 mb-3">
      <h4 class="text-uppercase">Our New Products</h4>
    ...
    <div class="swiper product-swiper open-up" data-aos="zoom-out">
      <div class="swiper-wrapper d-flex">
        ...
        $result = mysqli_query($conn, "SELECT * FROM tb_produk ORDER BY id DESC LIMIT 10");
          ...
          <div class="swiper-slide">
            <div class="product-item image-zoom-effect link-effect">
              <div class="image-holder position-relative">
                <!-- link ke halaman single product -->
                <a href="pages/single-product.php?id=<?= $row['id'] ?>">
                ...
                <!-- wishlist -->
                <!-- <a href="wishlist.php" class="btn-icon btn-wishlist">
                  <svg width="24" height="24" viewBox="0 0 24 24">
                    <use xlink:href="#heart"></use>
                  </svg>
                </a> -->
                ...
                <div class="product-content">
                  ...
                  <a href="pages/single-product.php?action=add&id=<?= $row['id'] ?>" 
        ...
        <?php endwhile; else: ?>
          <div class="swiper-slide">
            <div class="product-item">
              <p style="padding:20px; text-align:center;">Produk belum tersedia</p>
            </div>
          </div>
        <?php endif; ?>
        ...
        <div class="collection-item d-flex flex-wrap my-5">
          ...
          <div class="col-md-6 column-container bg-white">
            <div class="collection-content p-5 m-0 m-md-5">
              <h3 class="element-title text-uppercase">rules for rent</h3>
             <p>Renting kebaya, dresses, and heels is now easier at <strong>Gifaattire</strong>!
Fittings are available in person or via courier, with payment upfront and timely return in perfect condition.
For your safety, please send a photo of your ID card when renting.
Terms and conditions apply for both within and outside Cirebon.</p>
              <a href="pages/rules.php" class="btn btn-dark text-uppercase mt-3"> Read more</a>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="container">
    ...
    <div class="swiper product-swiper open-up" data-aos="zoom-out">
      <div class="swiper-wrapper d-flex">
        ...
        // Ambil 10 produk secara acak
        $result = mysqli_query($conn, "SELECT * FROM tb_produk ORDER BY RAND() LIMIT 10");
          ...
          <div class="product-item image-zoom-effect link-effect">
            <div class="image-holder position-relative">
              ...
              <div class="product-content">
                ...
                <a href="pages/single-product.php?action=add&id=<?= $row['id'] ?>" class="text-decoration-none" data-after="detail">
                  <span>Rp <?= number_format($row['price'],0,',','.') ?></span>
                </a>
              </div>
            </div>
        ...
        <div class="swiper-slide">
          <div class="product-item">
            <p style="padding:20px; text-align:center;">Produk best seller belum tersedia</p>
          </div>
        </div>
        <?php endif; ?>
      ...
      <div class="swiper-wrapper d-flex">
        <div class="swiper-slide">
          <div class="testimonial-item text-center">
            <blockquote>
              <p>  “Elegant set, neat package, amazing service!” <br>
                    — Alea R.</p>
        ...
        <div class="swiper-slide">
          <div class="testimonial-item text-center">
            <blockquote>
              <p> “Beautiful kebaya, great quality. Got lots of compliments!” <br>
                   — Melinda S.</p>
        ...
        <div class="swiper-slide">
          <div class="testimonial-item text-center">
            <blockquote>
              <p> “Smooth process, perfect fit, on time!” <br>
                   — Clara T.</p>
        ...
        <div class="swiper-slide">
          <div class="testimonial-item text-center">
            <blockquote>
              <p>“Comfy heels, pretty accessories. Love it!” <br>
                — Rani A.</p>
              <div class="review-title text-uppercase">uptop</div>
            </blockquote>
          </div>
...
<section id="best-sellers" class="best-sellers product-carousel py-5 position-relative overflow-hidden">
  <div class="container">
    ...
    <div class="swiper product-swiper open-up" data-aos="zoom-out">
      <div class="swiper-wrapper d-flex">
        ...
        // Ambil 10 produk secara acak
        $result = mysqli_query($conn, "SELECT * FROM tb_produk ORDER BY RAND() LIMIT 5");
  ...
  <section class="instagram position-relative">
    <div class="d-flex justify-content-center w-100 position-absolute bottom-0 z-1">
      <a href="https://www.instagram.com/gifaattire?igsh=aGVucGQ4OGtmdG0z" class="btn btn-dark px-5">Follow us on Instagram</a>
    </div>
    <div class="row g-0">
      <div class="col-6 col-sm-4 col-md-2">
        <div class="insta-item">
          <a href="https://www.instagram.com/gifaattire?igsh=aGVucGQ4OGtmdG0z" target="_blank">
  ...
  <svg width="200" height="50" xmlns="http://www.w3.org/2000/svg">
    <text x="0" y="35" font-family="Playfair Display, serif" font-size="50" fill="#111">Gifaattire</text>
  </svg>
</a>
...
We offer a wide selection of modern and traditional kebaya, elegant party dresses, and stylish heels to complete your look. Perfect for graduations, engagements, bridesmaids, and any other special event.</p>
        ...
        <div class="col-md-3 col-sm-6" id="contact">
          <div class="footer-menu footer-menu-004 border-animation-left" >
            <h5 class="widget-title text-uppercase mb-4" >Contact Us</h5>
            <p>Do you have any questions or suggestions? <a href="mailto:contact@yourcompany.com"
                class="item-anchor">gifaattire@gmail.com</a></p>
            <p>Do you need support? Give us a call. <a href="tel:+62 817 765 311" class="item-anchor">+62 817 765 311
                </a>
            </p>
          </div>
        </div>
